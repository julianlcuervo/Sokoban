...
/**Esta clase es la encargada de crear el nivel Facil y retornar la cantidad de movimientos 
 * 
...
public class Facil {
	/**
	 * 
	 * @return Este metodo retorna el resultado del nivel facil
	 */
	public static int Facil (){
...
//Se imprime el mapa inicial
	...
	if(mover.equals("d")){//Si el usuario espicha la tecla d se realiza la condicion
		...
		if(fila==1){//si el personaje se encuentra en la fila 1 realizara esta condicion
			...
			if((int)arreglo3.get(3)==4){
				arreglo3.remove(3);
				arreglo3.add(3,0);
			}
			if((int)arreglo3.get(5)==4){
				arreglo3.remove(5);
				arreglo3.add(5,0);
			}
			...
			if((int)arreglo3.get(3)==0){
				arreglo3.remove(3);
				arreglo3.add(3,4);
			}
			if((int)arreglo3.get(5)==0){
				arreglo3.remove(5);
				arreglo3.add(5,4);
			}
		}
		...
		if(fila==1){//si el personaje se encuentra en la fila 1 realizara esta condicion
			...
			for(int l=0;l<arreglo3.size;l++){//For encargado de los movimientos hacia abajo en la fila 3
		...
		if(fila==2){//si el personaje se encuentra en la fila 2 realizara esta condicion
			...
			for(int l=0;l<arreglo4.size;l++){//For encargado del movimiento hacia arriba en la fila 4
	...
	if((int)arreglo3.get(3)==8&&(int)arreglo3.get(5)==8){//Si se cumple significa que las cajas estan en su posicion
