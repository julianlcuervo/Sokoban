...
public class Medio {
	/**
	 * 
	 * @return Este metodo retorna el resultado del nivel Medio
	 */
	public static int Medio(){
		Scanner sc = new Scanner(System.in);
		int movimientos=0;//Esta variable entera cuenta los movimientos realizados
		int fila=3;//Esta variable entera indica la posicion inicial del jugador
	...
	if((int)arreglo1.get(3)==8&&(int)arreglo2.get(5)==8&&(int)arreglo4.get(3)==8){//Si se cumple significa que las cajas estan en su posicion
